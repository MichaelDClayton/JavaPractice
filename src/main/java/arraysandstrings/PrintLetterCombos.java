...
public class PrintLetterCombos {
	...
	private void helper(String digits, int index, HashMap<Character, char[]> dict, List<String> result, char[] arr){
	    if(index==digits.length()){
	    	/**
	    	 * if the we have reached the end of the char[] just add it the
	    	 * results.
	    	 * example:the array is not a but adh
	    	 */
	    	System.out.println("adding then returning");
